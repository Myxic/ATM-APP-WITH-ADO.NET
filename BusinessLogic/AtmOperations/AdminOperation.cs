    ...
    public class AdminOperation
    {
        ...
        public async Task<Admin> GetAdminDetails(string PinCode)
        {
            try
            {
                ...
                string getUserQuery = @$"SELECT BankAdminTable.First_name, BankAdminTable.Last_name, BankAdminTable.Gender, BankAdminTable.PinCode, BankAdminTable.Phone_Number FROM  BankAdminTable WHERE PinCode = '{Convert.ToInt32(PinCode)}' "; 
        ...
        public async Task<bool> AdminVerify(string Pin)
        {
            ...
            try
            {
                ...
                string getUserQuery = @$"SELECT *  FROM BankAdminTable  WHERE BankAdminTable.PinCode = '{Convert.ToInt32(Pin)}' ";
